...
export const priceFields: readonly FieldDef[] = [
  ...
  // ── WP-06 subject fields (API.md §6.1): b1m:, q: rate block, session state ───────────────────
  {
    id: 'BAR_TS',
    label: 'Bar time',
    definition:
      'Start of the interval a forming intraday bar covers, in UTC. On the b1m: subject a delta ' +
      'with IS_FINAL=true closes the bar and the next delta opens a new BAR_TS.',
    type: 'datetime',
    unit: 'datetime',
    decimals: null,
    fieldClass: 'price',
    assetClasses: [...QUOTED_WIDE],
    sources: [src('*', 'yahoo.chart', 'chart', 'timestamp[]')],
    updateFreq: '1m',
    pit: false,
    example: { ref: 'AAPL US Equity', value: '2026-09-15T18:41:00Z', asOf: '2026-09-15T18:41:28Z' },
    since: SINCE,
  },
  {
    id: 'VWAP',
    label: 'VWAP',
    definition:
      'Volume-weighted average price of the current regular session as the venue publishes it. ' +
      'Absent when no reachable source reports it; it is never computed from bars here.',
    type: 'number',
    unit: 'price',
    decimals: null,
    fieldClass: 'price',
    assetClasses: [...QUOTED],
    sources: [src('*', 'cboe.quotes', 'quotes', 'data.vwap')],
    updateFreq: 'tick',
    pit: false,
    example: { ref: 'AAPL US Equity', value: 330.02, asOf: '2026-09-15T18:41:28Z' },
    since: SINCE,
  },
  {
    id: 'SESSION_STATE',
    label: 'Session',
    definition:
      'Trading-session phase of the subject at the quote timestamp (FEED-06): pre, open, auction, ' +
      'halted, closed, post or unknown. Halts come from the venue; every other phase from the ' +
      'instrument calendar and the exchange session template.',
    type: 'enum',
    unit: 'enum',
    decimals: null,
    enumValues: ['pre', 'open', 'auction', 'halted', 'closed', 'post', 'unknown'],
    fieldClass: 'price',
    assetClasses: [...QUOTED_WIDE, 'option', 'govt', 'rate'],
    sources: [src('*', 'internal.derived', 'session', 'core/quote/session.ts#sessionState')],
    updateFreq: 'tick',
    pit: false,
    example: { ref: 'AAPL US Equity', value: 'open', asOf: '2026-09-15T18:41:28Z' },
    since: SINCE,
  },
  {
    id: 'RATE',
    label: 'Rate',
    definition:
      'Published level of a reference rate for the effective date, in percent (SOFR, EFFR, OBFR, ' +
      'the Treasury repo rates). It is the value the r: subject and the WIRP path key off.',
    type: 'number',
    unit: 'pct',
    decimals: 2,
    fieldClass: 'price',
    assetClasses: ['rate'],
    sources: [src('rate', 'nyfed.rates', 'rates', 'refRates[].percentRate')],
    updateFreq: 'daily',
    pit: true,
    example: { ref: 'SOFR Index', value: 4.31, asOf: '2026-09-15' },
    since: SINCE,
  },
  {
    id: 'RATE_P1',
    label: '1st percentile',
    definition: 'First percentile of the transaction-weighted rate distribution behind RATE, in percent.',
    type: 'number',
    unit: 'pct',
    decimals: 2,
    fieldClass: 'price',
    assetClasses: ['rate'],
    sources: [src('rate', 'nyfed.rates', 'rates', 'refRates[].percentPercentile1')],
    updateFreq: 'daily',
    pit: true,
    example: { ref: 'SOFR Index', value: 4.25, asOf: '2026-09-15' },
    since: SINCE,
  },
  {
    id: 'RATE_P25',
    label: '25th percentile',
    definition: 'Twenty-fifth percentile of the transaction-weighted rate distribution behind RATE, in percent.',
    type: 'number',
    unit: 'pct',
    decimals: 2,
    fieldClass: 'price',
    assetClasses: ['rate'],
    sources: [src('rate', 'nyfed.rates', 'rates', 'refRates[].percentPercentile25')],
    updateFreq: 'daily',
    pit: true,
    example: { ref: 'SOFR Index', value: 4.29, asOf: '2026-09-15' },
    since: SINCE,
  },
  {
    id: 'RATE_P75',
    label: '75th percentile',
    definition: 'Seventy-fifth percentile of the transaction-weighted rate distribution behind RATE, in percent.',
    type: 'number',
    unit: 'pct',
    decimals: 2,
    fieldClass: 'price',
    assetClasses: ['rate'],
    sources: [src('rate', 'nyfed.rates', 'rates', 'refRates[].percentPercentile75')],
    updateFreq: 'daily',
    pit: true,
    example: { ref: 'SOFR Index', value: 4.33, asOf: '2026-09-15' },
    since: SINCE,
  },
  {
    id: 'RATE_P99',
    label: '99th percentile',
    definition: 'Ninety-ninth percentile of the transaction-weighted rate distribution behind RATE, in percent.',
    type: 'number',
    unit: 'pct',
    decimals: 2,
    fieldClass: 'price',
    assetClasses: ['rate'],
    sources: [src('rate', 'nyfed.rates', 'rates', 'refRates[].percentPercentile99')],
    updateFreq: 'daily',
    pit: true,
    example: { ref: 'SOFR Index', value: 4.4, asOf: '2026-09-15' },
    since: SINCE,
  },
  {
    id: 'RATE_VOLUME_BN',
    label: 'Volume (bn)',
    definition: 'Dollar volume of the transactions behind the rate fixing, in billions of US dollars.',
    type: 'number',
    unit: 'bn',
    decimals: 0,
    fieldClass: 'price',
    assetClasses: ['rate'],
    sources: [src('rate', 'nyfed.rates', 'rates', 'refRates[].volumeInBillions')],
    updateFreq: 'daily',
    pit: true,
    example: { ref: 'SOFR Index', value: 2412, asOf: '2026-09-15' },
    since: SINCE,
  },
  {
    id: 'TARGET_FROM',
    label: 'Target range low',
    definition: 'Lower bound of the FOMC federal funds target range in force on the effective date, in percent.',
    type: 'number',
    unit: 'pct',
    decimals: 2,
    fieldClass: 'price',
    assetClasses: ['rate'],
    sources: [src('rate', 'nyfed.rates', 'rates', 'refRates[].targetRateFrom')],
    updateFreq: 'daily',
    pit: true,
    example: { ref: 'EFFR Index', value: 4.25, asOf: '2026-09-15' },
    since: SINCE,
  },
  {
    id: 'TARGET_TO',
    label: 'Target range high',
    definition: 'Upper bound of the FOMC federal funds target range in force on the effective date, in percent.',
    type: 'number',
    unit: 'pct',
    decimals: 2,
    fieldClass: 'price',
    assetClasses: ['rate'],
    sources: [src('rate', 'nyfed.rates', 'rates', 'refRates[].targetRateTo')],
    updateFreq: 'daily',
    pit: true,
    example: { ref: 'EFFR Index', value: 4.5, asOf: '2026-09-15' },
    since: SINCE,
  },
];
