...
// One screen component per function code (ARCHITECTURE §3.3).
//
...
import * as BTMM from './BTMM/Screen.js';
...
import * as HELP from './HELP/Screen.js';
import * as HP from './HP/Screen.js';
import * as MEMB from './MEMB/Screen.js';
