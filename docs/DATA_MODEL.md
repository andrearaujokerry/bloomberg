...
| 10 | `seed/fundamentals.ts` | `sec-companyfacts-AAPL.json` (503 us-gaap + 2 dei concepts ≈ 40k facts), `sec-submissions-AAPL.json` (1,000 filings), `sec-spy-submissions.json` (275), `sec-frames-assets.json` (6,264 Assets CY2024Q4I), `fixtures/seed/concept-map.json` | `xbrl_facts` ≈ 40k, `filings` 1,275, `xbrl_frames` 6,264, `xbrl_concept_map` ≈ 90, `fin_statements` ≈ 120 (AAPL Q/FY/TTM), `issuer_aliases` (SEC formerNames), `short_interest` 1 (`finra-trace`) | ≈ 48k |
