...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `cboe.quotes` | Cboe Global Markets | `exchange_delayed` | t/f/t/f | t/t | `delayed` | 15 | 400 | 4/s | no | — |
| `cboe.options` | Cboe Global Markets | `exchange_delayed` | t/f/t/f | t/t | `delayed` | 15 | 400 | 4/s | no | — |
| `cboe.symbolBook` | Cboe Global Markets | `exchange_delayed` | t/f/t/f | t/t | `eod` | 0 | — | 4/s | no | — |
| `cboe.euIndices` | Cboe Europe | `exchange_delayed` | t/f/t/f | t/t | `delayed` | 15 | 400 | 4/s | no | — |
| `yahoo.chart` | Yahoo | `unofficial` | t/f/t/f | t/**f** | `delayed` | 15 | — | 2/s | **yes** | — |
...
| `coingecko.simple` | CoinGecko | `unofficial` | t/f/t/f | t/f | `delayed` | 0 | 400 | 1/s | no | — |
